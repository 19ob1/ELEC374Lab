...
vcom -93 -work work {C:/altera/13.0sp1/elec374/ALU/tb3_13.vhd}

vsim -t 1ps -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneiii -L rtl_work -L work -voptargs="+acc"  tb3_13
